  ...
  useEffect(() => {
    const loadStackSuggestions = async () => {
      ...
      const stackSuggestions: StackSuggestions = {
        suggestions: {
          frontend: suggestions.frontend || [],
          backend: suggestions.backend || [],
          database: suggestions.database || [],
          aiService: suggestions.aiService || [],
          secretSauce: suggestions.secretSauce || []
        },
        aiRecommendations,
        templateInfo,
