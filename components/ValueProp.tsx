  ...
  return (
    <section ref={sectionRef} id="valueprop" className="py-20 px-6 md:px-8 lg:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        {/* What You Get */}
        <div className={`bg-gray-950/50 border border-gray-800 rounded-lg p-8 mb-16 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className={`flex items-start gap-3 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
            ...
            <div className={`flex items-start gap-3 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
              <div className="w-8 h-8 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className={`flex items-start gap-3 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.5s' }}>
              <div className="w-8 h-8 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className={`flex items-start gap-3 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
              <div className="w-8 h-8 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className={`flex items-start gap-3 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.7s' }}>
              <div className="w-8 h-8 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          <div className={`mt-8 p-4 bg-green-950/20 border border-green-800/30 rounded-lg text-center ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
        ...
        <div className={`max-w-4xl mx-auto ${isVisible ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.9s' }}>
          <h3 className="text-2xl font-bold text-center mb-8">We solve the problems that keep you stuck</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className={`p-6 bg-red-950/20 border border-red-800/30 rounded-lg text-center ${isVisible ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '1.0s' }}>
            ...
            <div className={`p-6 bg-yellow-950/20 border border-yellow-800/30 rounded-lg text-center ${isVisible ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '1.1s' }}>
            ...
            <div className={`p-6 bg-orange-950/20 border border-orange-800/30 rounded-lg text-center ${isVisible ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '1.2s' }}>
